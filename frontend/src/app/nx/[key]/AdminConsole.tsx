...
export default function AdminConsole() {
  ...
  // attach it to staff calls. Safe: this component only renders when the
  // server already verified the segment.
  useEffect(() => {
    if (params?.key) localStorage.setItem("nx_panel", String(params.key));
  }, [params]);

  // Gate: check the session is actually an admin
  useEffect(() => {
